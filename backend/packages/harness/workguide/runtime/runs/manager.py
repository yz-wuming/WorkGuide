...
from workguide.runtime.user_context import AUTO, _AutoSentinel, resolve_user_id
from workguide.utils.time import is_lease_expired
from workguide.utils.time import now_iso as _now_iso
...
class RunManager:
    ...
    async def _admit_thread_operation(
        ...
        *,
        ...
        try:
            ...
            cleanup.set_name(f"workguide-close-cancelled-admission-{record.run_id}")
    ...
    async def start_heartbeat(self) -> None:
        ...
        task.set_name("workguide-run-lease-heartbeat")
    ...
    def _schedule_orphan_reconciliation(self) -> None:
        ...
        task.set_name("workguide-periodic-orphan-recovery")
    ...
    async def shutdown(self, *, timeout: float = 5.0) -> None:
        ...
        shutdown (bytedance/workguide issue #3373).
