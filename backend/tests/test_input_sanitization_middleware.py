...
from workguide.agents.middlewares.input_sanitization_middleware import (
    _BLOCKED_TAG_NAMES,
    _USER_INPUT_BEGIN,
    _USER_INPUT_END,
...
from workguide.agents.middlewares.message_utils import is_genuine_user_message
...
def test_denylist_covers_framework_authority_blocks():
    ...
    harness_root = pathlib.Path(workguide.__file__).parent
