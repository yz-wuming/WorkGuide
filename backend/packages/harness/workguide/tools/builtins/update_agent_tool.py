...
from workguide.config.agents_config import load_agent_config, preserve_non_managed_fields, validate_agent_name
from workguide.config.app_config import get_app_config
from workguide.config.paths import get_paths
from workguide.persistence.agents import get_agent_store
...
# ``workguide.agents.lead_agent.agent``); this set is the in-tool mirror
...
def update_agent(
    ...
    # ``workguide.agents.lead_agent.agent``). The same channel set is
