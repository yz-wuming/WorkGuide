...
from workguide.agents import thread_state as thread_state_module
...
from workguide.agents.thread_state import ThreadState, merge_delegations
...
from workguide.subagents.status_contract import make_subagent_additional_kwargs
    ...
    def test_skill_reference_survives_summarization_and_stays_injected(self):
        ...
        agent = create_agent(
            ...
            middleware=[
                ...
                DurableContextMiddleware(),
                WorkGuideSummarizationMiddleware(model=summary_model, trigger=("messages", 4), keep=("messages", 2), token_counter=len),
            ],
            state_schema=ThreadState,
            checkpointer=InMemorySaver(),
        )
