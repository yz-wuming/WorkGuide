...
from workguide.tools.mcp_metadata import get_mcp_routing
...
async def test_mcp_tool_name_prefix_can_be_disabled_per_server_without_disabling_stdio_pooling() -> None:
    ...
    with (
        ...
        patch("workguide.mcp.tools.build_mcp_tool_interceptors", return_value=[]),
        ...
        patch("workguide.mcp.tools._make_session_pool_tool", side_effect=lambda tool, *_args, **_kwargs: tool) as wrap_tool,
    ):
