...
from workguide.config.paths import VIRTUAL_PATH_PREFIX, Paths
from workguide.constants import MCP_TMP_SUBDIR
from workguide.mcp import tools as mcp_tools
...
def _patch_paths(paths: Paths):
    return patch("workguide.mcp.tools.get_paths", return_value=paths)
