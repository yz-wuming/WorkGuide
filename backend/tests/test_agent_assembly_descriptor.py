...
from workguide_extension_api import AgentAssemblyDescriptor, MiddlewareDescriptor, ToolDescriptor
...
class TestLeadAgentAssembly:
    def test_make_lead_agent_still_returns_a_bare_graph(self):
        ...
        from workguide.agents.lead_agent.agent import make_lead_agent
    ...
    def test_assemble_returns_both_the_graph_and_a_descriptor(self, monkeypatch):
        from workguide.agents.lead_agent.agent import LeadAgentAssembly, assemble_lead_agent
    ...
    def test_descriptor_hashes_the_same_scoped_prompt_passed_to_the_graph(self, monkeypatch):
        from workguide_extension_api import canonical_hash
    ...
    def test_observers_receive_the_descriptor(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "workguide.extensions.notify.notify_agent_assembled",
    ...
    def test_no_descriptor_is_built_without_a_registered_observer(self, monkeypatch):
        ...
        monkeypatch.setattr("workguide.agents.assembly_descriptor.build_assembly_descriptor", _fail)
        self._isolate_from_the_ambient_config(monkeypatch)
...
class TestFactoryConsumersUnwrapTheGraph:
    ...
    def test_worker_unwraps_the_assembly(self):
        ...
        from workguide.runtime.runs.worker import _agent_graph
...
class TestWrappedExtensionMiddlewaresStayDistinguishable:
    ...
    def test_two_extensions_middlewares_do_not_collapse_into_one_descriptor(self):
        from workguide.agents.assembly_descriptor import describe_middleware
...
class TestCustomAgentModelSettingsReachTheDescriptor:
    ...
    def test_temperature_override_on_a_custom_agent_changes_the_fingerprint(self, monkeypatch):
        from workguide.agents.lead_agent import agent as lead_agent_module
        from workguide.agents.lead_agent.agent import assemble_lead_agent
        from workguide.config.agents_config import AgentConfig, AgentModelSettings
        from workguide.extensions import bind_agent_build_extensions
...
class TestSkillCatalogHashesContent:
    ...
    def test_required_secrets_flag_changes_the_fingerprint(self):
        from workguide.skills.types import SecretRequirement
