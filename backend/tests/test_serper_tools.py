...
def reset_api_key_warned():
    ...
    import workguide.community.serper.tools as serper_mod
...
def mock_config_with_key():
    with patch("workguide.community.serper.tools.get_app_config") as mock:
...
class TestGetApiKey:
    def test_returns_config_key_when_present(self):
        with patch("workguide.community.serper.tools.get_app_config") as mock:
            ...
            from workguide.community.serper.tools import _get_api_key
...
class TestCoerceMaxResults:
    def test_returns_value_when_valid_positive_int(self):
        from workguide.community.serper.tools import _coerce_max_results
...
class TestSafePublicUrl:
    def test_https_public_hostname_passes(self):
        from workguide.community.serper.tools import _safe_public_url
...
class TestWebSearchTool:
    def test_basic_search_returns_normalized_results(self, mock_config_with_key):
        ...
        with patch("workguide.community.serper.tools.httpx.Client") as mock_client_cls:
            mock_client_cls.return_value.__enter__.return_value.post.return_value = mock_resp

            from workguide.community.serper.tools import web_search_tool
    ...
    def test_missing_api_key_logs_warning_once(self, mock_config_no_key, caplog):
        ...
        with patch.dict("os.environ", {}, clear=True):
            ...
            with caplog.at_level(logging.WARNING, logger="workguide.community.serper.tools"):
...
class TestImageSearchTool:
    def test_basic_search_returns_normalized_results(self, mock_config_with_key):
        ...
        with patch("workguide.community.serper.tools.httpx.Client") as mock_client_cls:
            ...
            from workguide.community.serper.tools import image_search_tool
...
def test_package_exports_image_search_tool():
    from workguide.community.serper import image_search_tool
    from workguide.community.serper.tools import image_search_tool as direct_image_search_tool
