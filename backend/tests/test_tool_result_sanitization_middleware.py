...
WorkGuide neutralizes framework/injection tags in the genuine user message. These
...
from workguide.agents.middlewares.input_sanitization_middleware import _check_user_content
from workguide.agents.middlewares.tool_result_sanitization_middleware import (
    ToolResultSanitizationMiddleware,
    _neutralize_content,
)
from workguide.community.browserless.browserless_client import BrowserlessScreenshotResult
from workguide.community.browserless.tools import _target_status_warning
