"""Declarative feature flags and middleware positioning for create_workguide_agent.
...
class RuntimeFeatures:
    """Declarative feature flags for ``create_workguide_agent``.
    ...
    # Explicit memory config for direct create_workguide_agent(features=...) callers.
