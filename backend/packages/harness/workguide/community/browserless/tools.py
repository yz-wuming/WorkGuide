...
from workguide.community.url_safety import resolve_host_addresses as _resolve_host_addresses
from workguide.community.url_safety import validate_public_http_url
...
from workguide.utils.readability import ReadabilityExtractor
...
async def web_capture_tool(
    ...
    Only capture exact URLs provided by the user or discovered through other tools. Do not use this for private pages behind login unless the user has explicitly configured Browserless outside WorkGuide.
