...
``README.md`` documents WorkGuide as being deployed by default "in a local
...
def test_dev_frontend_allows_default_loopback_origins():
    ...
    assert "WORKGUIDE_DEV_ALLOWED_ORIGINS=${WORKGUIDE_DEV_ALLOWED_ORIGINS:-127.0.0.1,::1}" in environment
