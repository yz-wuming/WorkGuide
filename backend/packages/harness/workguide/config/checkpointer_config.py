...
class CheckpointerConfig(BaseModel):
    ...
    type: CheckpointerType = Field(
        ...
        "'postgres' persists to PostgreSQL (install with workguide-harness[postgres])."
    )
    connection_string: str | None = Field(
        ...
        "For sqlite, use a file path like '.workguide/checkpoints.db' or ':memory:' for in-memory. "
...
def ensure_config_loaded() -> None:
    ...
    from workguide.config.app_config import _app_config, get_app_config
