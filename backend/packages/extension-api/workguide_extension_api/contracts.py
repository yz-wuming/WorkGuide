...
if TYPE_CHECKING:  # pragma: no cover - typing only
    from workguide_extension_api.assembly import AgentAssemblyObserver
    from workguide_extension_api.compaction import ContextCompactionObserver
    from workguide_extension_api.placement import AgentBuildContext, MiddlewarePlacement
...
def extension(*, api: str, name: str | None = None) -> Callable[[F], F]:
    ...
    def _decorate(func: F) -> F:
        func.__workguide_api__ = api  # type: ignore[attr-defined]
        func.__workguide_name__ = name  # type: ignore[attr-defined]
        return func
