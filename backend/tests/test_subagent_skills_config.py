...
class TestRegistryCustomAgentLookup:
    ...
    def test_get_available_subagent_names_falls_back_when_subagents_app_config_lacks_sandbox(self, monkeypatch):
        from workguide.subagents import registry as registry_module
        from workguide.subagents.registry import get_available_subagent_names
    ...
    def test_builtin_takes_priority_over_custom(self):
        ...
        from workguide.subagents.builtins import BUILTIN_SUBAGENTS
        from workguide.subagents.registry import get_subagent_config
...
class TestRegistryAvailableNames:
    ...
    def test_includes_builtin_names(self):
        from workguide.subagents.registry import get_subagent_names
...
class TestRegistryListSubagentsWithCustom:
    ...
    def test_list_includes_custom_agents(self):
        from workguide.subagents.registry import list_subagents
