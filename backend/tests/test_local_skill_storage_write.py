...
from workguide.skills.storage import get_or_new_skill_storage, reset_skill_storage
...
def user_storage(tmp_path):
    ...
    with patch("workguide.config.paths.get_paths", return_value=Paths(base_dir=tmp_path)):
