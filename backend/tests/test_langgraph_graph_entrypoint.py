...
def test_langgraph_config_loads_the_repository_environment_file():
    """Standalone Studio should reuse the root environment used by WorkGuide."""
    import json
