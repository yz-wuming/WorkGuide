...
from workguide.agents.memory import MemoryConflictError, MemoryCorruptionError, MemoryManager, get_memory_manager
...
async def get_memory(http_request: Request) -> MemoryResponse:
    ...
    Example Response:
        ```json
        {
            ...
            "user": {
                "workContext": {"summary": "Working on WorkGuide project", "updatedAt": "..."},
