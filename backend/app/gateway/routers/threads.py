...
:func:`workguide.runtime.serialization.serialize_channel_values` to
...
from workguide.agents.thread_state import THREAD_STATE_REDUCER_FIELDS
from workguide.config.paths import Paths, get_paths
from workguide.config.summarization_config import ContextSize
from workguide.persistence.thread_meta import THREAD_PINNED_METADATA_KEY
from workguide.runtime import ThreadOperationKind, serialize_channel_values_for_api
from workguide.runtime.checkpoint_mode import CheckpointModeMismatchError, CheckpointModeReconfigurationError
from workguide.runtime.checkpoint_state import graph_reducer_channels, graph_state_schema, graph_writable_channels
from workguide.runtime.context_compaction import (
...
from workguide.runtime.journal import build_branch_history_seed_events
from workguide.runtime.runs.manager import ConflictError
from workguide.runtime.runs.worker import RUN_MESSAGE_IDS_METADATA_KEY, valid_duration_entry, valid_run_message_id_entry
from workguide.runtime.secret_context import redact_metadata_secrets
from workguide.runtime.user_context import get_effective_user_id
from workguide.utils.file_io import run_file_io
from workguide.utils.thread_id import ThreadId, resolve_thread_id, validate_thread_id
from workguide.utils.time import coerce_iso, now_iso
...
_SIDECAR_METADATA_KEY = "workguide_sidecar"
_BRANCH_METADATA_KEY = "workguide_branch"
...
class ThreadSearchRequest(BaseModel):
    ...
    def _validate_metadata_filters(cls, v: dict[str, Any]) -> dict[str, Any]:
        ...
        See ``workguide.persistence.json_compat`` for the shared validators.
        """
        if not v:
            return v
        from workguide.persistence.json_compat import validate_metadata_filter_key, validate_metadata_filter_value
...
async def delete_thread_data(thread_id: str, request: Request) -> ThreadDeleteResponse:
    ...
    Cleans WorkGuide-managed thread directories, removes checkpoint data,
...
async def search_threads(body: ThreadSearchRequest, request: Request) -> list[ThreadResponse]:
    ...
    """
    from app.gateway.deps import get_thread_store
    from workguide.persistence.thread_meta import InvalidMetadataFilterError
...
async def _persist_run_history_metadata_background(
    *,
    ...
    from workguide.runtime.runs.worker import persist_run_history_metadata
