...
LLM_PROVIDERS: list[LLMProvider] = [
    ...
    LLMProvider(
        ...
        use="workguide.models.mindie_provider:MindIEChatModel",
...
SEARCH_PROVIDERS: list[SearchProvider] = [
    ...
    SearchProvider(
        ...
        use="workguide.community.infoquest.tools:web_search_tool",
    ...
    SearchProvider(
        ...
        use="workguide.community.exa.tools:web_search_tool",
        env_var="EXA_API_KEY",
        extra_config={
            "max_results": 5,
            "search_type": "auto",
    ...
    SearchProvider(
        ...
        use="workguide.community.firecrawl.tools:web_search_tool",
    ...
    SearchProvider(
        ...
        use="workguide.community.fastcrw.tools:web_search_tool",
        env_var="CRW_API_KEY",
        extra_config={"max_results": 5},
    ),
    SearchProvider(
        ...
        use="workguide.community.brave.tools:web_search_tool",
    ...
    SearchProvider(
        ...
        use="workguide.community.serply.tools:web_search_tool",
    ...
    SearchProvider(
        ...
        use="workguide.community.groundroute.tools:web_search_tool",
...
WEB_FETCH_PROVIDERS: list[WebProvider] = [
    ...
    WebProvider(
        ...
        use="workguide.community.exa.tools:web_fetch_tool",
        env_var="EXA_API_KEY",
        tool_name="web_fetch",
    ),
    WebProvider(
        ...
        display_name="InfoQuest",
        description="API key required",
        use="workguide.community.infoquest.tools:web_fetch_tool",
        env_var="INFOQUEST_API_KEY",
        tool_name="web_fetch",
    ...
    WebProvider(
        ...
        use="workguide.community.firecrawl.tools:web_fetch_tool",
        env_var="FIRECRAWL_API_KEY",
        tool_name="web_fetch",
    ),
    WebProvider(
        ...
        use="workguide.community.groundroute.tools:web_fetch_tool",
        env_var="GROUNDROUTE_API_KEY",
        tool_name="web_fetch",
    ),
    WebProvider(
        ...
        use="workguide.community.fastcrw.tools:web_fetch_tool",
        env_var="CRW_API_KEY",
        tool_name="web_fetch",
    ),
    WebProvider(
        ...
        use="workguide.community.crawl4ai.tools:web_fetch_tool",
        env_var=None,
        tool_name="web_fetch",
