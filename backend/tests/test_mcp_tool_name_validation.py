...
def _load(server_tools: list[StructuredTool]) -> tuple[list, MagicMock]:
    ...
    with (
        ...
        patch("workguide.config.extensions_config.ExtensionsConfig.from_file", return_value=ext),
        patch("workguide.mcp.tools.build_servers_config", return_value={"srv": {"transport": "sse"}}),
