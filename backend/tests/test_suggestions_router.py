...
from workguide.utils import oneshot_llm
...
def _clear_langfuse_env(monkeypatch):
    ...
    for name in ("LANGFUSE_TRACING", "LANGFUSE_PUBLIC_KEY", "LANGFUSE_SECRET_KEY", "LANGFUSE_BASE_URL", "WORKGUIDE_ENV", "ENVIRONMENT"):
...
def test_generate_suggestions_injects_workguide_trace_metadata_when_langfuse_enabled(monkeypatch):
    ...
    assert metadata["workguide_trace_id"] == "suggest-trace-1"
