"""Logging setup helpers for WorkGuide."""
...
_TRACE_FILTER_NAME = "workguide_trace_context_filter"
...
class JsonTraceFormatter(logging.Formatter):
    ...
    _workguide_trace_formatter = True
...
def configure_logging(config: object) -> None:
    """Configure WorkGuide logging from an AppConfig-like object.
    ...
    for handler in logging.root.handlers:
        if enhanced:
            ...
            if getattr(handler.formatter, "_workguide_trace_formatter", False):
