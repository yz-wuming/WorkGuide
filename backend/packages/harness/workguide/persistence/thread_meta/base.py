...
three-state semantics (see :mod:`workguide.runtime.user_context`):
...
THREAD_PINNED_METADATA_KEY = "workguide_pinned"
...
class ThreadMetaStore(abc.ABC):
    ...
    async def search(
        ...
        *,
        ...
        (``metadata.workguide_pinned is True``), then by ``updated_at`` and
