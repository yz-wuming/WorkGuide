...
Background — see issue bytedance/workguide#4271.
...
content. WorkGuide should preserve that content for audit, but it should not
...
from workguide.agents.middlewares.model_length_termination_detectors import (
