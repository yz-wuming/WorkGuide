...
#   deploy/helm/workguide/Chart.yaml    (version: + appVersion:)
#
...
CHART="$ROOT/deploy/helm/workguide/Chart.yaml"
...
# deploy/helm/workguide/Chart.yaml — version: X.Y.Z and appVersion: "X.Y.Z"
...
echo "  deploy/helm/workguide/Chart.yaml (version + appVersion)"
echo
