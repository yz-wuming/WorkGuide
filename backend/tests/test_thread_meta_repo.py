...
from workguide.persistence.thread_meta import THREAD_PINNED_METADATA_KEY, InvalidMetadataFilterError, ThreadMetaRepository
...
class TestThreadMetaRepository:
    ...
    async def test_search_metadata_all_unsafe_keys_raises(self, repo, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger="workguide.persistence.thread_meta.sql"):
...
class TestJsonMatchCompilation:
    ...
    def test_json_match_compiles_sqlite(self):
        ...
        from workguide.persistence.json_compat import json_match
...
class TestJsonValueMatches:
    def test_distinguishes_missing_null_bool_int_and_float(self):
        from workguide.persistence.json_compat import json_value_matches
