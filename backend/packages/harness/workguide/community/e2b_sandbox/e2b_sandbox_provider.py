"""``E2BSandboxProvider`` — WorkGuide :class:`SandboxProvider` for e2b cloud.
...
from workguide.sandbox.sandbox_provider import SandboxProvider
...
META_KEY_USER = "work_guide_user"
META_KEY_THREAD = "work_guide_thread"
META_KEY_PROVIDER = "work_guide_provider"
META_KEY_GATEWAY = "work_guide_gateway"
META_KEY_CREATED_AT = "work_guide_created_at"
META_KEY_CAPACITY_LEDGER = "work_guide_capacity_ledger"
META_KEY_CAPACITY_RESERVATION = "work_guide_capacity_reservation"
...
class E2BSandboxProvider(SandboxProvider):
    ...
    def __init__(self) -> None:
        ...
        # Active sandboxes, keyed by WorkGuide-side sandbox id (== e2b id).
    ...
    def _create_sandbox(self, thread_id: str | None, *, user_id: str) -> str:
        ...
        # Materialise WorkGuide's virtual path layout (/mnt/user-data/...) inside
    ...
    def _bootstrap_sandbox_paths(self, client: E2BClientSandbox) -> None:
        """Materialise WorkGuide's virtual path layout inside the e2b VM.
    ...
    def _skill_projection_mounts(self, user_id: str) -> list[tuple[Path, str, bool]]:
        ...
        """
        from workguide.skills.projection import ensure_skill_projections
    ...
    def _sync_outputs_to_host(
        ...
        *,
        ...
        WorkGuide's ``/api/threads/{tid}/artifacts/...`` endpoint resolves
        ...
        """
        from workguide.config.paths import get_paths  # lazy import to avoid cycles
