...
from workguide.persistence.scheduled_tasks import ActiveScheduledTaskMutationConflict, ScheduledTaskRepository
...
async def test_update_after_launch_rejects_stale_lease_owner(tmp_path, caplog):
    ...
    try:
        ...
        with caplog.at_level("WARNING", logger="workguide.persistence.scheduled_tasks.sql"):
