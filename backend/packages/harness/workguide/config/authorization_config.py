...
When enabled, a pluggable :class:`~workguide.authz.provider.AuthorizationProvider`
...
run-time execution deny (reuses :class:`~workguide.guardrails.middleware.GuardrailMiddleware`
...
class AuthorizationProviderConfig(BaseModel):
    ...
    use: str = Field(description="Class path (e.g. 'workguide.authz.rbac:RbacAuthorizationProvider')")
...
class AuthorizationConfig(BaseModel):
    ...
    Mirrors :class:`~workguide.config.guardrails_config.GuardrailsConfig` in
