...
from workguide.sandbox.local import local_sandbox
...
def test_sandbox_config_exposes_command_timeout_default():
    cfg = SandboxConfig(use="workguide.sandbox.local:LocalSandboxProvider")
...
def test_bash_tool_description_guides_backgrounding_long_lived_processes():
    ...
    from workguide.sandbox.tools import bash_tool
