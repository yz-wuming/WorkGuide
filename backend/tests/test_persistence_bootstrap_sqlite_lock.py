...
The cache (``workguide.persistence.bootstrap._SQLITE_LOCKS``) maps an engine
...
from workguide.persistence import bootstrap as bootstrap_mod
from workguide.persistence.bootstrap import _get_sqlite_local_lock
