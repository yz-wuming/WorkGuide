...
from workguide.agents.middlewares.subagent_limit_middleware import (
...
from workguide.agents.thread_state import DelegationEntry
...
class TestTruncateTaskCalls:
    ...
    def test_missing_run_id_logs_fail_restrictive_fallback(self, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger="workguide.agents.middlewares.subagent_limit_middleware"):
            result = mw._truncate_task_calls(state)
