...
from workguide.tui.app import WorkGuideTUI, SelectScreen
from workguide.tui.cli import LaunchPlan
from workguide.tui.theme import THEME
...
async def test_transparent_tui_uses_terminal_default_for_background_surfaces():
    app = WorkGuideTUI(_FakeSession(), LaunchPlan(mode="tui", transparent=True))
