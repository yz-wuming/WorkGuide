...
_MCP_STDIO_COMMAND_ALLOWLIST_ENV = "WORKGUIDE_MCP_STDIO_COMMAND_ALLOWLIST"
...
class McpUserScopedAuthConfigResponse(BaseModel):
    ...
    users: dict[str, str] = Field(default_factory=dict, description="Map of WorkGuide user id to credential header value")
