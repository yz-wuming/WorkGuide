...
from workguide.community.infoquest import tools
from workguide.community.infoquest.infoquest_client import InfoQuestClient
...
class TestInfoQuestClient:
    ...
    @patch("workguide.community.infoquest.infoquest_client.requests.post")
    ...
    @patch("workguide.community.infoquest.tools._get_infoquest_client")
    ...
    @patch("workguide.community.infoquest.tools.get_app_config")
...
class TestImageSearch:
    ...
    # In /Users/bytedance/python/workguidev2/workguide/backend/tests/test_infoquest_client.py
