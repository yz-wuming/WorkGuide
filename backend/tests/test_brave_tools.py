...
def reset_api_key_warned():
    ...
    import workguide.community.brave.tools as brave_mod
...
def mock_config_with_key():
    with patch("workguide.community.brave.tools.get_app_config") as mock:
...
class TestGetApiKey:
    def test_returns_config_key_when_present(self):
        with patch("workguide.community.brave.tools.get_app_config") as mock:
            ...
            from workguide.community.brave.tools import _get_api_key
...
class TestWebSearchTool:
    def test_basic_search_returns_normalized_results(self, mock_config_with_key):
        ...
        with patch("workguide.community.brave.tools.httpx.Client") as mock_client_cls:
            mock_client_cls.return_value.__enter__.return_value.get.return_value = mock_resp

            from workguide.community.brave.tools import web_search_tool
    ...
    def test_invalid_max_results_falls_back_to_default(self, caplog):
        with patch("workguide.community.brave.tools.get_app_config") as mock:
            ...
            with patch("workguide.community.brave.tools.httpx.Client") as mock_client_cls:
                ...
                with caplog.at_level("WARNING", logger="workguide.community.brave.tools"):
                    result = web_search_tool.invoke({"query": "test"})
                parsed = json.loads(result)
                params = mock_get.call_args.kwargs["params"]
    ...
    def test_missing_api_key_logs_warning_once(self, mock_config_no_key, caplog):
        ...
        with patch.dict("os.environ", {}, clear=True):
            ...
            with caplog.at_level(logging.WARNING, logger="workguide.community.brave.tools"):
...
class TestSafePublicUrl:
    def test_https_public_hostname_passes(self):
        from workguide.community.brave.tools import _safe_public_url
...
class TestImageSearchTool:
    def test_basic_image_search_returns_normalized_results(self, mock_config_with_key):
        ...
        with patch("workguide.community.brave.tools.httpx.Client") as mock_client_cls:
            ...
            from workguide.community.brave.tools import image_search_tool
    ...
    def test_image_search_missing_api_key_logs_warning_once_per_tool(self, mock_config_no_key, caplog):
        ...
        with patch.dict("os.environ", {}, clear=True):
            from workguide.community.brave.tools import image_search_tool, web_search_tool
...
def test_package_exports_image_search_tool():
    from workguide.community.brave import image_search_tool
    from workguide.community.brave.tools import image_search_tool as direct_image_search_tool
