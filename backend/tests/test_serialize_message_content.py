...
See: https://github.com/bytedance/workguide/issues/1149
"""
...
class TestSerializeToolMessageContent:
    """WorkGuideClient._serialize_message should normalize ToolMessage content."""
...
class TestExtractText:
    """WorkGuideClient._extract_text should handle all content shapes."""

    def test_string_passthrough(self):
        assert WorkGuideClient._extract_text("hello") == "hello"

    def test_list_text_blocks(self):
        assert WorkGuideClient._extract_text([{"type": "text", "text": "hi"}]) == "hi"

    def test_empty_list(self):
        assert WorkGuideClient._extract_text([]) == ""

    def test_fallback_non_iterable(self):
        assert WorkGuideClient._extract_text(123) == "123"
