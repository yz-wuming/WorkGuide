...
import pytest
from workguide_extension_api import EXTENSION_TASK_STORE_KEY, ExtensionData, TaskInfo, TaskOutcome
...
def env():
    ...
    try:
        ...
        sys.modules["workguide.subagents.executor"].get_app_config = lambda: SimpleNamespace(
