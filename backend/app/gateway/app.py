...
from workguide_extension_api import EXTENSION_PRINCIPAL_RESOLVER_KEY, ExtensionPrincipal
...
from workguide.config import app_config as workguide_app_config
from workguide.logging_config import DEFAULT_LOG_DATE_FORMAT, DEFAULT_LOG_FORMAT, configure_logging
from workguide.tracing.monocle import setup_monocle_tracing_if_enabled
from workguide.uploads.manager import cleanup_stale_upload_staging_files

AppConfig = workguide_app_config.AppConfig
get_app_config = workguide_app_config.get_app_config
...
async def _ensure_admin_user(app: FastAPI) -> None:
    ...
    "no-auth → with-auth" upgrade path: users who ran WorkGuide without
    ...
    from workguide.persistence.engine import get_session_factory
...
async def lifespan(app: FastAPI) -> AsyncGenerator[None, None]:
    ...
    from workguide.skills.projection import ensure_public_skill_projection
    ...
    # plain `import workguide.agents` never installs a process-global tracer.
    ...
    async with langgraph_runtime(app, startup_config):
        ...
        from workguide.mcp.task_tool_caller import McpTaskToolCaller
        from workguide.mcp.tasks import (
            ORDINARY_MCP_TASK_DRIVER,
            McpTaskDriverRegistry,
            OrdinaryMcpTaskDriver,
        )
        from workguide.mcp.tasks.runtime import (
        ...
        from workguide.subagents.batch_runtime import set_subagent_batch_submitter
        ...
        if getattr(app.state, "mcp_task_service", None) is not None:
            ...
            try:
                ...
                from workguide.mcp.tasks.runtime import set_mcp_task_submitter

                set_mcp_task_submitter(None)
        from workguide.mcp.tasks.runtime import set_mcp_task_config_snapshot
        ...
        try:
            from workguide.community.browser_automation import get_browser_session_manager
        ...
        try:
            ...
            from workguide.extensions.notify import suspend_extension_system_observations
...
def create_app() -> FastAPI:
    ...
    app = FastAPI(
        title="WorkGuide API Gateway",
        description="""
## WorkGuide API Gateway

API Gateway for WorkGuide - A LangGraph-based AI agent backend with sandbox execution capabilities.
...
This gateway provides runtime endpoints for agent runs plus custom endpoints for models, MCP configuration, skills, and artifacts.
        ...
        openapi_tags=[
            ...
            {
                "name": "threads",
                "description": "Manage WorkGuide thread-local filesystem data",
            },
            {
                "name": "agents",
    ...
    from workguide.extensions import (
        EMPTY_EXTENSIONS,
        ExtensionLoadError,
    ...
    # (or when the explicit WORKGUIDE_ALLOW_UNVERIFIED_GITHUB_WEBHOOKS=1
    ...
    if github_webhooks.is_route_enabled():
        ...
        logger.warning("GitHub webhooks route NOT mounted: GITHUB_WEBHOOK_SECRET unset and WORKGUIDE_ALLOW_UNVERIFIED_GITHUB_WEBHOOKS not set. /api/webhooks/github will respond 404. Configure either env var to enable the route.")
    ...
    async def health_check() -> dict[str, str]:
        ...
        """
        return {"status": "healthy", "service": "workguide-gateway"}
    ...
    from workguide.extensions.gateway import include_contributed_routers
