"""Pure view-state reducer for the WorkGuide TUI.
...
The runtime bridge (``workguide.tui.runtime``) is responsible for translating
``WorkGuideClient`` ``StreamEvent`` objects into these actions; the Textual app
