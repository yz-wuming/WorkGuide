...
WorkGuide tools annotate their runtime parameter as ``Runtime``
(``workguide.tools.types.Runtime`` = ``ToolRuntime[dict[str, Any], ThreadState]``)
...
tool call because the actual context WorkGuide installs is a dict. Using the
...
from workguide.tools.builtins.list_uploaded_files_tool import list_uploaded_files
from workguide.tools.builtins.present_file_tool import present_file_tool
from workguide.tools.builtins.setup_agent_tool import setup_agent
from workguide.tools.builtins.task_tool import task_tool
from workguide.tools.builtins.update_agent_tool import update_agent
from workguide.tools.builtins.view_image_tool import view_image_tool
