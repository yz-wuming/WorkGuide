"""Authorization decorators and context for WorkGuide.
...
from workguide.authz.provider import AuthorizationProvider, AuthzDecision, AuthzRequest, Principal
...
def _make_test_request_stub() -> Any:
    ...
    """
    return SimpleNamespace(state=SimpleNamespace(), cookies={}, _workguide_test_bypass_auth=True)
...
def authorize_sandbox_for_request(
    ...
    *,
    ...
    :class:`~workguide.sandbox.exceptions.SandboxAuthorizationError` on deny or
...
def require_auth[**P, T](func: Callable[P, T]) -> Callable[P, T]:
    ...
    async def wrapper(*args: Any, **kwargs: Any) -> Any:
        ...
        if getattr(request, "_workguide_test_bypass_auth", False):
        ...
        async def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            if owner_check:
                ...
                if not allowed and getattr(auth.user, "system_role", None) == INTERNAL_SYSTEM_ROLE:
                    ...
                    # the connection owner carried in X-WorkGuide-Owner-User-Id.
