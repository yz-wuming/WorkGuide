...
from workguide.skills.types import SKILL_MD_FILE, Skill, SkillCategory  # noqa: F401
...
class SkillStorage(ABC):
    ...
    def validate_skill_markdown_content(name: str, content: str) -> None:
        ...
        from workguide.skills.validation import _validate_skill_frontmatter
    ...
    def get_skills_root_path(self) -> Path:
        ...
        Origin: ``workguide.skills.loader.get_skills_root_path``.
        """
    ...
    def _iter_skill_files(self) -> Iterable[tuple[SkillCategory, Path, Path]]:
        ...
        ``workguide.skills.loader.load_skills``.
        """
    ...
    def read_custom_skill(self, name: str) -> str:
        ...
        Origin: ``workguide.skills.manager.read_custom_skill_content``.
        """
    ...
    def write_custom_skill(self, name: str, relative_path: str, content: str) -> None:
        ...
        Origin: ``workguide.skills.manager.atomic_write``.
        """
    ...
    def custom_skill_exists(self, name: str) -> bool:
        """Origin: ``workguide.skills.manager.custom_skill_exists``."""

    @abstractmethod
    def public_skill_exists(self, name: str) -> bool:
        """Origin: ``workguide.skills.manager.public_skill_exists``."""

    @abstractmethod
    def append_history(self, name: str, record: dict) -> None:
        """Append a JSONL history entry for ``name``.

        Origin: ``workguide.skills.manager.append_history``.
        """
    ...
    def read_history(self, name: str) -> list[dict]:
        ...
        Origin: ``workguide.skills.manager.read_history``.
        """
    ...
    def get_container_root(self) -> str:
        """Origin: ``workguide.config.skills_config.SkillsConfig.container_path`` accessor."""
        return self._container_root

    def get_custom_skill_dir(self, name: str) -> Path:
        """Path to ``custom/<name>``. Does not create the directory.

        Origin: ``workguide.skills.manager.get_custom_skill_dir``.
        """
    ...
    def get_custom_skill_file(self, name: str) -> Path:
        ...
        Origin: ``workguide.skills.manager.get_custom_skill_file``.
        """
        normalized_name = self.validate_skill_name(name)
    ...
    def get_skill_history_file(self, name: str) -> Path:
        ...
        **incorrect** for :class:`UserScopedSkillStorage`. Subclasses that
        ...
        Origin: ``workguide.skills.manager.get_skill_history_file``.
        """
        normalized_name = self.validate_skill_name(name)
    ...
    def load_skills(self, *, enabled_only: bool = False) -> list[Skill]:
        ...
        Origin: ``workguide.skills.loader.load_skills``.
        """
    ...
    def ensure_custom_skill_is_editable(self, name: str) -> None:
        """Origin: ``workguide.skills.manager.ensure_custom_skill_is_editable``.
