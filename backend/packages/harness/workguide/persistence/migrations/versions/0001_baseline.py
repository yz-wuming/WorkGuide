"""baseline -- chain root for WorkGuide application schema.
...
every WorkGuide-owned table at the point alembic was wired in. Under the hybrid
bootstrap strategy (``workguide.persistence.bootstrap.bootstrap_schema``), the
