...
#### [`packages/harness/workguide/agents/thread_state.py`](../packages/harness/workguide/agents/thread_state.py)
- ✅ 添加 `title: str | None = None` 字段到 `ThreadState`

#### [`packages/harness/workguide/config/title_config.py`](../packages/harness/workguide/config/title_config.py) (新建)
- ✅ 创建 `TitleConfig` 配置类
...
#### [`packages/harness/workguide/agents/middlewares/title_middleware.py`](../packages/harness/workguide/agents/middlewares/title_middleware.py) (新建)
...
#### [`packages/harness/workguide/config/app_config.py`](../packages/harness/workguide/config/app_config.py)
- ✅ 导入 `load_title_config_from_dict`
- ✅ 在 `from_file()` 中加载 title 配置

#### [`packages/harness/workguide/agents/lead_agent/agent.py`](../packages/harness/workguide/agents/lead_agent/agent.py)
- ✅ 导入 `TitleMiddleware`
...
checkpointer = SqliteSaver.from_conn_string("workguide.db")
```
...
{
  "graphs": {
    "lead_agent": "workguide.agents:lead_agent"
  },
