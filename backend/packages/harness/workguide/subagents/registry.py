...
from workguide.persistence.managed_subagents import ManagedSubagentDefinition, get_managed_subagent_store
...
def _resolve_subagents_app_config(app_config: Any | None = None):
    if app_config is None:
        from workguide.config.subagents_config import get_subagents_app_config
