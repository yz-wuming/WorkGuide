"""Tests for workguide.models.factory.create_chat_model."""
...
from workguide.models import factory as factory_module
from workguide.models import openai_codex_provider as codex_provider_module
from workguide.reflection import resolve_class
...
def test_context_window_never_reaches_the_provider_client(monkeypatch):
    """Context sizing metadata belongs to WorkGuide, not the provider SDK."""
...
def test_thinking_disabled_vllm_chat_template_format(monkeypatch):
    ...
    model = _make_model(
        "vllm-qwen",
        use="workguide.models.vllm_provider:VllmChatModel",
        supports_thinking=True,
        when_thinking_enabled=wte,
    )
...
def test_create_chat_model_resolves_patched_mimo_provider(model_id):
    from workguide.models.patched_mimo import PatchedChatMiMo
...
def test_no_duplicate_kwarg_when_reasoning_effort_in_config_and_thinking_disabled(monkeypatch):
    ...
    model = ModelConfig(
        ...
        description=None,
        use="workguide.models.patched_deepseek:PatchedChatDeepSeek",
...
_STREAM_TIMEOUT_OPENAI_SUBCLASS_USE_PATHS = [
    "workguide.models.vllm_provider:VllmChatModel",
    "workguide.models.mindie_provider:MindIEChatModel",
    "workguide.models.patched_deepseek:PatchedChatDeepSeek",
    "workguide.models.patched_mimo:PatchedChatMiMo",
    "workguide.models.patched_stepfun:PatchedChatStepFun",
    "workguide.models.patched_minimax:PatchedChatMiniMax",
]
...
def test_api_base_preserved_for_provider_that_declares_it(monkeypatch):
    ...
    """
    from workguide.models.patched_deepseek import PatchedChatDeepSeek

    cfg = _make_app_config([_make_model_with_extras("ds", use="workguide.models.patched_deepseek:PatchedChatDeepSeek", api_base="http://ds/v3")])
    captured: dict = {}
...
def test_api_base_normalized_for_patched_chatopenai(monkeypatch):
    ...
    from workguide.models.patched_openai import PatchedChatOpenAI

    cfg = _make_app_config([_make_model_with_extras("patched", use="workguide.models.patched_openai:PatchedChatOpenAI", api_base="http://localhost:4001/v1")])
    captured: dict = {}
    ...
    cfg = _make_app_config(
        [
            _make_model_with_extras(
                "minimax",
                use="workguide.models.patched_minimax:PatchedChatMiniMax",
                api_key="sk-dummy",
...
def test_codex_still_strips_overridden_max_tokens(monkeypatch):
    ...
    cfg = _make_app_config([_make_model("codex", use="workguide.models.openai_codex_provider:CodexChatModel")])
    captured: dict = {}
    monkeypatch.setattr(factory_module, "get_app_config", lambda: cfg)
