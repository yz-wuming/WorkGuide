...
from workguide.uploads.manager import is_upload_staging_file
from workguide.utils.file_outline import extract_outline_for_file
from workguide.utils.messages import ORIGINAL_USER_CONTENT_KEY, message_content_to_text
...
class UploadsMiddleware(AgentMiddleware[UploadsMiddlewareState]):
    ...
    async def abefore_agent(self, state: UploadsMiddlewareState, runtime: Runtime) -> dict | None:
        ...
        LangGraph's runnable config and WorkGuide's request ContextVar fallback.
