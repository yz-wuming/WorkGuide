...
A tool is "MCP-sourced" when it carries the ``workguide_mcp`` metadata flag.
...
MCP_TOOL_METADATA_KEY = "workguide_mcp"
MCP_TOOL_ROUTING_METADATA_KEY = "workguide_mcp_routing"
MCP_TOOL_SOURCE_METADATA_KEY = "workguide_mcp_source"
