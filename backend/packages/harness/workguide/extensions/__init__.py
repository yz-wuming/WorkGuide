"""WorkGuide's extension mechanism (host side).

The public contracts live in the separate `workguide-extension-api` package;
...
from workguide.extensions.registry import EMPTY_EXTENSIONS, ExtensionRegistry, LoadedExtensions
