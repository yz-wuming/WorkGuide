...
from workguide.extensions import resolve_run_extensions
from workguide.runtime.user_context import resolve_runtime_user_id
from workguide.sandbox.security import LOCAL_BASH_SUBAGENT_DISABLED_MESSAGE, is_host_bash_allowed
from workguide.subagents import SubagentExecutor, get_available_subagent_names, get_subagent_config
from workguide.subagents.capacity import SubagentExecutionCapacity
from workguide.subagents.config import resolve_subagent_model_name
...
from workguide.trace_context import WORKGUIDE_TRACE_METADATA_KEY, get_current_trace_id, normalize_trace_id
from workguide.utils.custom_events import aemit_custom_event
...
_explicit_execution_capacity: ContextVar[SubagentExecutionCapacity | None] = ContextVar(
    "workguide_explicit_subagent_execution_capacity",
    default=None,
)
_explicit_app_config: ContextVar[Any | None] = ContextVar(
    "workguide_explicit_subagent_app_config",
    default=None,
)
...
async def task_tool(
    ...
    workguide_trace_id = normalize_trace_id(parent_context.get(WORKGUIDE_TRACE_METADATA_KEY)) or normalize_trace_id(metadata.get(WORKGUIDE_TRACE_METADATA_KEY)) or get_current_trace_id()
