...
_SESSION_NAMESPACE = "workguide-openviking-adapter-v1"
...
def _canonical_peer_id(
    ...
    """Map WorkGuide's case-insensitive agent names to disjoint peer IDs."""
...
def _session_id(
    ...
    """Derive one stable OpenViking session for one WorkGuide thread."""
...
def _captureable_messages(
    ...
    """Drop WorkGuide-only injected context before handing messages to OpenViking."""
