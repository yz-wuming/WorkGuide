...
class DiscordChannel(Channel):
    ...
    def __init__(self, bus: MessageBus, config: dict[str, Any]) -> None:
        ...
        # conversations to WorkGuide thread IDs — a different concern.
        ...
        if store is not None:
            ...
            self._thread_store_path = Path.home() / ".workguide" / "channels" / "discord_threads.json"
    ...
    async def _bind_connection_from_connect_code(self, message, code: str) -> bool:
        ...
        await self._send_connection_reply(message, "Discord connected to WorkGuide.")
        return True
    ...
    async def _create_thread(self, message):
        try:
            ...
            thread_name = f"workguide-{message.author.display_name}-{message.id}"[:100]
