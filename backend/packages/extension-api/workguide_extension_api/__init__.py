"""Public contracts for WorkGuide extensions.

This package MUST NOT import `workguide`. Every host contract an extension
...
from workguide_extension_api.assembly import (
    AgentAssemblyDescriptor,
    AgentAssemblyObserver,
    MiddlewareDescriptor,
    ToolDescriptor,
)
from workguide_extension_api.auth import (
    EXTENSION_PRINCIPAL_RESOLVER_KEY,
    ExtensionPrincipal,
    require_admin,
    resolve_principal,
)
from workguide_extension_api.compaction import (
    CompactionEvent,
    ContextCompactionObserver,
)
from workguide_extension_api.contracts import (
    ExtensionInstall,
    ExtensionRegistry,
...
from workguide_extension_api.placement import (
    AgentBuildContext,
    AgentScope,
    MiddlewarePlacement,
    Placement,
)
from workguide_extension_api.provenance import (
...
from workguide_extension_api.release import (
...
from workguide_extension_api.state import ExtensionData
