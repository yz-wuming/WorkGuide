...
async def test_gate_catches_unoffloaded_blocking_io_in_workguide_module(tmp_path: Path) -> None:
    from workguide.runtime.store._sqlite_utils import ensure_sqlite_parent_dir
