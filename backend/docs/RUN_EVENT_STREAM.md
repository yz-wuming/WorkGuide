...
The run event stream is WorkGuide's append-only record of what happened during
...
categories live in `workguide.runtime.events.catalog`; conformance tests require
