#!/bin/sh
# Stage the WorkGuide sandbox lark-cli runtime layout from official release
...
#   <dest>/.workguide-lark-cli-runtime.json   {"version": "vX.Y.Z"}
#
...
# backend/packages/harness/workguide/integrations/lark_cli.py
...
printf '{\n  "version": "%s"\n}\n' "$TAG" > "${DEST}/.workguide-lark-cli-runtime.json"
