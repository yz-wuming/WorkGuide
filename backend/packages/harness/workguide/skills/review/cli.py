...
from workguide.skills.review.models import DEFAULT_PACKAGE_LIMITS, SEVERITY_RANK, PackageLimits, stable_json_dumps
from workguide.skills.review.readers import ArchivePackageReader, LocalDirectoryReader
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--profile", choices=["workguide", "agentskills"], default="workguide")
