...
``langchain_openai.ChatOpenAI`` currently ignores that field, so WorkGuide's
...
which WorkGuide already understands.
"""
...
class PatchedChatMiniMax(ChatOpenAI):
    ...
    def _strip_user_message_names(payload: dict) -> None:
        ...
        WorkGuide middlewares tag user messages with internal provenance names
