...
from workguide.agents.lead_agent.prompt import refresh_skills_system_prompt_cache_async
from workguide.config.app_config import AppConfig
from workguide.integrations.lark_cli import (
...
class LarkCliProbeResponse(BaseModel):
    available: bool = Field(..., description="Whether lark-cli is available to the Gateway, either managed by WorkGuide or on PATH")
