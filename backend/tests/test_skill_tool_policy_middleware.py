...
from workguide.runtime.secret_context import SKILL_TOOL_POLICY_DECISION_CONTEXT_KEY, write_slash_skill_source_path
...
@pytest.mark.parametrize(
    ...
    [
        "workguide.agents.middlewares.skill_activation_middleware.SkillActivationMiddleware",
        "workguide.agents.middlewares.skill_tool_policy_middleware.SkillToolPolicyMiddleware",
    ],
)
...
def test_slash_activation_and_policy_compose_on_the_same_model_call(monkeypatch):
    from workguide.agents.middlewares.skill_activation_middleware import SkillActivationMiddleware, _Activation, _ActivationResolution
