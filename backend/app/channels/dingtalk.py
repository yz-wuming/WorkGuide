...
from workguide.config.paths import VIRTUAL_PATH_PREFIX, get_paths
...
from workguide.uploads.manager import UnsafeUploadPathError, claim_unique_filename, normalize_filename, write_upload_file_no_symlink
    ...
    async def _bind_connection_from_connect_code(
        ...
        *,
        ...
        await self._send_connection_reply(
            ...
            sender_staff_id,
            conversation_id,
            "DingTalk connected to WorkGuide.",
        )
        return True
        ...
        async with httpx.AsyncClient(timeout=httpx.Timeout(30.0)) as client:
            response = await client.post(
                ...
                json={
                    ...
                    "msgParam": json.dumps({"title": "WorkGuide", "text": text}),
                    "robotCode": robot_code,
                    "userIds": [user_id],
                },
            )
