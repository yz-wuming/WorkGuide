...
from workguide.tools.builtins.review_skill_package_tool import review_skill_package
...
def test_review_skill_package_inline_returns_review_subject_metadata():
    ...
    assert message.artifact["facts"]["schema_version"] == "workguide.skill-review.facts.v1"
...
def test_review_skill_package_installed_skill_uses_storage_without_activation(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("workguide.tools.builtins.review_skill_package_tool.get_or_new_user_skill_storage", lambda user_id: storage)
