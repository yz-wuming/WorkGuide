...
from workguide.agents.thread_state import (
    DeltaThreadState,
    ThreadState,
...
def test_merge_message_writes_normalizes_state_and_each_write_once(monkeypatch: pytest.MonkeyPatch) -> None:
    import workguide.agents.thread_state as thread_state
...
def test_agents_package_exports_delta_thread_state() -> None:
    from workguide.agents import DeltaThreadState as ExportedDeltaThreadState
