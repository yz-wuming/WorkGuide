...
from workguide.skills.slash import parse_slash_skill_reference, resolve_slash_skill
...
from workguide.skills.types import SKILL_MD_FILE, SecretRequirement, Skill, SkillCategory
from workguide.utils.messages import get_original_user_content_text, is_real_user_message
...
{escaped_skill_content}
    ...
    def _resolve_registry_skill(self, registry: dict[str, Skill], path: object, *, require_autonomous: bool) -> Skill | None:
        ...
        by-name fallback would be a confused deputy: WorkGuide lets a custom skill
