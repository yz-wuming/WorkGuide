...
from workguide.agents.goal_state import GoalState
from workguide.agents.thread_state import DeltaThreadState, merge_message_writes
from workguide.runtime.checkpoint_mode import CHECKPOINT_MODE_METADATA_KEY, checkpoint_tuple_uses_delta
from workguide.runtime.checkpoint_state import CheckpointStateAccessor
from workguide.runtime.goal import write_thread_goal
from workguide.runtime.runs.worker import _ensure_interrupted_title, persist_run_durations
...
# ---------------------------------------------------------------------------
# InMemorySaver delta-history patch guards (workguide.checkpoint_patches)
# ---------------------------------------------------------------------------
...
def test_inmemory_delta_history_patch_is_active() -> None:
    ...
    from workguide import checkpoint_patches
