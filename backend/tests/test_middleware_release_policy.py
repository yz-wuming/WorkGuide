...
import pytest
from workguide_extension_api import ReleasePolicyProvider, canonical_hash, canonical_json, collect_release_policies
...
def _make_summarization_middleware():
    ...
    return WorkGuideSummarizationMiddleware(
...
_MIDDLEWARE_DECLARATIONS = [
    ("workguide.agents.middlewares.loop_detection_middleware", "LoopDetectionMiddleware", _make_loop_detection_middleware),
    ("workguide.agents.middlewares.subagent_limit_middleware", "SubagentLimitMiddleware", _make_subagent_limit_middleware),
    ("workguide.agents.middlewares.terminal_response_middleware", "TerminalResponseMiddleware", _make_terminal_response_middleware),
    # WorkGuide's own subclass, not the LangChain base class re-exported into
    # this module under the same import path (TodoListMiddleware).
    ("workguide.agents.middlewares.todo_middleware", "TodoMiddleware", _make_todo_middleware),
    ("workguide.agents.middlewares.token_budget_middleware", "TokenBudgetMiddleware", _make_token_budget_middleware),
    ("workguide.agents.middlewares.deferred_tool_filter_middleware", "DeferredToolFilterMiddleware", _make_deferred_tool_filter_middleware),
    ("workguide.agents.middlewares.safety_finish_reason_middleware", "SafetyFinishReasonMiddleware", _make_safety_finish_reason_middleware),
    ("workguide.agents.middlewares.summarization_middleware", "WorkGuideSummarizationMiddleware", _make_summarization_middleware),
    ("workguide.agents.middlewares.tool_output_budget_middleware", "ToolOutputBudgetMiddleware", _make_tool_output_budget_middleware),
    ("workguide.agents.middlewares.skill_activation_middleware", "SkillActivationMiddleware", _make_skill_activation_middleware),
    ("workguide.agents.middlewares.system_message_coalescing_middleware", "SystemMessageCoalescingMiddleware", _make_system_message_coalescing_middleware),
]
