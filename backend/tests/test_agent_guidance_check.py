...
EXPECTED_GUIDANCE_PATHS = {
    ...
    "backend/packages/harness/workguide/AGENTS.md",
    "backend/packages/harness/workguide/agents/AGENTS.md",
    "backend/packages/harness/workguide/agents/middlewares/AGENTS.md",
    "backend/packages/harness/workguide/agents/memory/AGENTS.md",
    "backend/packages/harness/workguide/config/AGENTS.md",
    "backend/packages/harness/workguide/extensions/AGENTS.md",
    "backend/packages/harness/workguide/runtime/AGENTS.md",
    "backend/packages/harness/workguide/sandbox/AGENTS.md",
    "backend/packages/harness/workguide/mcp/AGENTS.md",
    "backend/packages/harness/workguide/models/AGENTS.md",
    "backend/packages/harness/workguide/persistence/migrations/AGENTS.md",
    "backend/packages/harness/workguide/reflection/AGENTS.md",
    "backend/packages/harness/workguide/skills/AGENTS.md",
    "backend/packages/harness/workguide/subagents/AGENTS.md",
    "backend/packages/harness/workguide/tools/AGENTS.md",
    "backend/packages/harness/workguide/tracing/AGENTS.md",
    "backend/packages/harness/workguide/tui/AGENTS.md",
...
def _load_checker():
    ...
    spec = importlib.util.spec_from_file_location("workguide_agent_guidance_check", CHECKER_PATH)
...
def test_local_guidance_files_contain_the_split_original_sections() -> None:
    expected_headings = {
        ...
        "backend/packages/harness/workguide/agents/AGENTS.md": "### Agent System",
        "backend/packages/harness/workguide/agents/middlewares/AGENTS.md": "### Middleware Chain",
        "backend/packages/harness/workguide/agents/memory/AGENTS.md": "### Memory System",
        "backend/packages/harness/workguide/config/AGENTS.md": "### Configuration System",
        "backend/packages/harness/workguide/extensions/AGENTS.md": "### Python Extension System",
        "backend/packages/harness/workguide/runtime/AGENTS.md": "### Checkpoint Channel Modes",
        "backend/packages/harness/workguide/sandbox/AGENTS.md": "### Sandbox System",
        "backend/packages/harness/workguide/mcp/AGENTS.md": "### MCP System",
        "backend/packages/harness/workguide/models/AGENTS.md": "### Model Factory",
        "backend/packages/harness/workguide/persistence/migrations/AGENTS.md": "### Schema Migrations",
        "backend/packages/harness/workguide/reflection/AGENTS.md": "### Reflection System",
        "backend/packages/harness/workguide/skills/AGENTS.md": "### Skills System",
        "backend/packages/harness/workguide/subagents/AGENTS.md": "### Subagent System",
        "backend/packages/harness/workguide/tools/AGENTS.md": "### Tool System",
        "backend/packages/harness/workguide/tracing/AGENTS.md": "### Tracing System",
        "backend/packages/harness/workguide/tui/AGENTS.md": "### Terminal Workbench / TUI",
