...
```python
from workguide.config.title_config import TitleConfig, set_title_config
...
- [`packages/harness/workguide/agents/thread_state.py`](../packages/harness/workguide/agents/thread_state.py) - ThreadState 定义
- [`packages/harness/workguide/agents/middlewares/title_middleware.py`](../packages/harness/workguide/agents/middlewares/title_middleware.py) - TitleMiddleware 实现
- [`packages/harness/workguide/config/title_config.py`](../packages/harness/workguide/config/title_config.py) - 配置管理
- [`config.yaml`](../../config.example.yaml) - 配置文件
- [`packages/harness/workguide/agents/lead_agent/agent.py`](../packages/harness/workguide/agents/lead_agent/agent.py) - Middleware 注册
