...
from workguide.agents.middlewares import skill_activation_middleware as middleware_module
from workguide.agents.middlewares.skill_activation_middleware import SkillActivationMiddleware, is_slash_skill_activation_reminder
from workguide.config.extensions_config import ExtensionsConfig
from workguide.config.paths import Paths
from workguide.skills.slash import RESERVED_SLASH_SKILL_NAMES, parse_slash_skill_reference, resolve_slash_skill
...
def test_skill_activation_middleware_reads_public_skill_from_real_user_scoped_storage(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("workguide.config.extensions_config.get_extensions_config", lambda: extensions_config)
