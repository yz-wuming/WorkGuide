...
from workguide.agents.middlewares.summarization_middleware import SummaryGenerationError
from workguide.runtime import context_compaction
from workguide.runtime.checkpoint_state import CheckpointStateAccessor
from workguide.runtime.context_compaction import ContextCompactionFailed, compact_thread_context
...
async def test_compact_thread_context_reads_materialized_state_and_overwrites_messages(monkeypatch):
    ...
    import workguide.config.agents_config as agents_config
