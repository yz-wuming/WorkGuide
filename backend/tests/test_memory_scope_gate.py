...
from workguide.agents.memory.backends.deermem.deermem.core.storage import MemoryStorage
from workguide.agents.memory.backends.deermem.deermem.core.updater import MemoryUpdater, _extract_text, _normalize_memory_update_data
from workguide.agents.memory.manager import _host_default_extraction_callback
