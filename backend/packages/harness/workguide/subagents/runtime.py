"""Explicit runtime dependencies for direct ``create_workguide_agent`` use."""
...
from workguide.subagents.batch_runtime import SubagentBatchSubmitter
...
class SubagentRuntime:
    ...
    ``create_workguide_agent`` can expose the bound batch tools, and stop it
    ...
    def __init__(
        ...
        *,
        ...
        if batch_repository is not None:
            from workguide.subagents.batch_service import SubagentBatchService
