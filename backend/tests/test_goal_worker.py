...
import pytest
from workguide_extension_api import ExtensionData
...
from workguide.runtime.goal import GoalEvaluation, attach_goal_evaluation, build_goal_state, latest_visible_assistant_signature, read_thread_goal, write_thread_goal
...
def test_stand_down_reason_uses_documented_default_caps_when_missing():
    ...
    from workguide.runtime.goal import should_continue_goal
