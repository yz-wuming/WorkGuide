...
The default WorkGuide runtime is embedded in the FastAPI Gateway; scripts and
...
# StudioUser was added after WorkGuide's historical langgraph-sdk floor. Resolve
