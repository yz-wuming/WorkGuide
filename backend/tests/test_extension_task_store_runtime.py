...
import pytest
from workguide_extension_api import EXTENSION_TASK_STORE_KEY, ExtensionData
...
from workguide.runtime.runs.worker import RunContext, _build_runtime_context, run_agent
...
def _subagent_env():
    ...
    sys.modules.pop("workguide.subagents.executor", None)
    ...
    try:
        ...
        from workguide.subagents.executor import SubagentExecutor, SubagentResult, SubagentStatus
