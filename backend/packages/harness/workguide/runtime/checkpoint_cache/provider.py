...
from workguide.runtime.checkpoint_cache.base import CACHE_FORMAT_VERSION, CheckpointHistoryCache
from workguide.runtime.checkpoint_cache.memory import MemoryCheckpointHistoryCache

logger = logging.getLogger(__name__)

_ENV_REDIS_URL = "WORKGUIDE_CHECKPOINT_CACHE_REDIS_URL"
...
async def make_checkpoint_cache(
    ...
    *,
    ...
    if config.type == "redis":
        from workguide.runtime.checkpoint_cache.redis import RedisCheckpointHistoryCache
