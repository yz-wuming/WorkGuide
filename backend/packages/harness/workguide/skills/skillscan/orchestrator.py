"""Native deterministic scanning for WorkGuide skills.
...
from workguide.skills.package_paths import is_eval_fixture_skill_md
from workguide.skills.skillscan.models import (
    FindingSeverity,
    RuleSpec,
    ScanResult,
    SecurityFinding,
