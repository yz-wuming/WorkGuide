"""Summarization middleware extensions for WorkGuide."""
...
from workguide_extension_api import CompactionEvent, canonical_hash
...
from workguide.extensions.notify import notify_context_compacted
from workguide.models import create_chat_model
from workguide.utils.messages import is_real_user_message
...
class WorkGuideSummarizationMiddleware(SummarizationMiddleware):
        ...
        *,
        ...
        try:
            ...
            if extensions is None:
                ...
                from workguide_extension_api import SystemOperationKind

                from workguide.extensions.notify import observe_system_model_call
    ...
    def _freeze_compaction_sources(self, messages_to_summarize: list[AnyMessage]) -> tuple[str, ...]:
        ...
        WorkGuide messages are routinely multimodal (``list[dict]`` content, e.g.
    ...
    async def acompact_state(
        ...
        *,
        ...
        if prepared is None:
            return None
        messages_to_summarize, preserved_messages, previous_summary, total_tokens = prepared
        from workguide_extension_api import task_store_from_runtime
