...
INTERNAL_AUTH_HEADER_NAME = "X-WorkGuide-Internal-Token"
INTERNAL_OWNER_USER_ID_HEADER_NAME = "X-WorkGuide-Owner-User-Id"
INTERNAL_AUTH_ENV_VAR = "WORKGUIDE_INTERNAL_AUTH_TOKEN"
...
def get_internal_user(owner_user_id: str | None = None):
    ...
    ``X-WorkGuide-Owner-User-Id`` header), the synthetic user's ``.id``
