#!/usr/bin/env python3
"""Collect Kubernetes sandbox pod memory snapshots for WorkGuide.
...
DEFAULT_NAMESPACE = "workguide"
DEFAULT_SELECTOR = "app=workguide-sandbox"
...
def render_markdown(report: dict[str, Any]) -> str:
    ...
    lines = [
        "# WorkGuide Sandbox Memory Profile",
        "",
