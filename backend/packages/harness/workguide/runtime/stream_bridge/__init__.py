...
# optional extra, and this package is pulled in transitively by ``workguide.runtime``
...
# directly from ``workguide.runtime.stream_bridge.redis`` if you need the class.
