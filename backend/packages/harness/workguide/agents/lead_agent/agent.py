...
from workguide.agents.lead_agent.prompt import apply_prompt_template
from workguide.agents.middlewares.clarification_middleware import ClarificationMiddleware
from workguide.agents.middlewares.configured_extensions import load_configured_extension_middlewares
from workguide.agents.middlewares.loop_detection_middleware import LoopDetectionMiddleware
from workguide.agents.middlewares.memory_middleware import MemoryMiddleware
from workguide.agents.middlewares.model_length_finish_reason_middleware import ModelLengthFinishReasonMiddleware
from workguide.agents.middlewares.safety_finish_reason_middleware import SafetyFinishReasonMiddleware
from workguide.agents.middlewares.subagent_limit_middleware import SubagentLimitMiddleware
from workguide.agents.middlewares.summarization_middleware import WorkGuideSummarizationMiddleware, create_summarization_middleware
from workguide.agents.middlewares.terminal_response_middleware import TerminalResponseMiddleware
from workguide.agents.middlewares.title_middleware import TitleMiddleware
from workguide.agents.middlewares.todo_middleware import TodoMiddleware
from workguide.agents.middlewares.token_usage_middleware import TokenUsageMiddleware
from workguide.agents.middlewares.tool_error_handling_middleware import build_lead_runtime_middlewares
from workguide.agents.middlewares.view_image_middleware import ViewImageMiddleware
from workguide.agents.thread_state import get_thread_state_schema, normalize_middleware_state_schemas
from workguide.authz.principal import build_principal_from_context
...
from workguide.config.agents_config import load_agent_config, validate_agent_name
from workguide.config.app_config import AppConfig, get_app_config
from workguide.config.memory_config import should_use_memory_tools
from workguide.config.subagents_config import (
...
from workguide.skills.types import Skill
from workguide.subagents.capacity import configured_subagent_max_running
from workguide.tracing import build_tracing_callbacks
...
def _subagent_release_policy(
    ...
    *,
    ...
    from workguide.subagents import get_available_subagent_names, get_subagent_config
...
def _append_memory_tools_without_name_conflicts(tools: list) -> None:
    ...
    from workguide.agents.memory.tools import get_memory_tools
...
def _create_summarization_middleware(
    *,
    ...
    extensions=None,
) -> WorkGuideSummarizationMiddleware | None:
...
def _create_todo_list_middleware(is_plan_mode: bool) -> TodoMiddleware | None:
    ...
    # Custom prompts matching WorkGuide's style
    system_prompt = """
<todo_list_system>
...
def build_middlewares(
    ...
    *,
    ...
    ``make_lead_agent`` and by the embedded ``WorkGuideClient`` (a lead-agent variant
    ...
    from workguide.extensions import get_agent_build_extensions
    ...
    from workguide.agents.middlewares.dynamic_context_middleware import DynamicContextMiddleware
    ...
    if should_use_memory_tools(resolved_app_config.memory):
        from workguide.agents.memory.manager import backend_requires_passive_writes_in_tool_mode
    ...
    if deferred_setup is not None and deferred_setup.deferred_names:
        ...
        from workguide.agents.middlewares.mcp_routing_middleware import assert_mcp_routing_before_deferred_filter
    ...
    from workguide_extension_api import AgentScope

    from workguide.extensions.stack import compose_with_extensions
    ...
    from workguide_extension_api import AgentBuildContext

    from workguide.extensions.policy import project_host_policy
...
def _load_enabled_available_skills(available_skills: set[str] | None, *, app_config: AppConfig, user_id: str | None = None) -> list[Skill]:
    try:
        from workguide.agents.lead_agent.prompt import get_enabled_skills_for_config
...
def _complete_assembly(
    *,
    ...
    from workguide.agents.assembly_descriptor import build_assembly_descriptor
    from workguide.extensions.notify import notify_agent_assembled
...
def _assemble_lead_agent(config: RunnableConfig, *, app_config: AppConfig) -> LeadAgentAssembly:
    ...
    from workguide.tools.builtins import setup_agent, update_agent
    from workguide.tools.builtins.tool_search import assemble_deferred_tools, build_mcp_routing_middleware, get_mcp_routing_hints_prompt_section
    ...
    from workguide.runtime.user_context import resolve_config_user_id
    ...
    from workguide.skills.describe import build_skill_search_setup
