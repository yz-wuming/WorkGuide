...
``.workguide/threads/{thread_id}/runs/{run_id}.jsonl``
...
from workguide.runtime.events.store.base import RunEventStore, match_ai_message_run_id, normalize_message_ids
...
class JsonlRunEventStore(RunEventStore):
    def __init__(self, base_dir: str | Path | None = None):
        self._base_dir = Path(base_dir) if base_dir else Path(".workguide")
