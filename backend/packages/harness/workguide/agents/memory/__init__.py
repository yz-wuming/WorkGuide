"""Pluggable memory for WorkGuide.
...
set ``MemoryConfig.manager_class`` -- nothing else in workguide changes.
...
them directly from ``workguide.agents.memory.backends.deermem.deermem.core.*``.
"""
