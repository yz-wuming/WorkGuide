...
Background — see issues bytedance/workguide#3028 (truncated tool calls) and
...
from workguide.agents.middlewares.safety_termination_detectors import (
    SafetyTermination,
    SafetyTerminationDetector,
    default_detectors,
)
from workguide.agents.middlewares.tool_call_metadata import clone_ai_message_with_tool_calls
from workguide.runtime.events.catalog import MIDDLEWARE_SAFETY_TERMINATION_TAG
from workguide.utils.custom_events import aemit_custom_event, emit_custom_event
