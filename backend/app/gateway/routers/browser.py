...
from workguide.runtime.user_context import get_effective_user_id, reset_current_user, set_current_user
...
async def navigate_browser(thread_id: ThreadId, body: BrowserNavigateRequest, request: Request) -> BrowserNavigateResponse:
    ...
    try:
        from workguide.community.browser_automation import navigate_and_capture, redact_browser_url
...
async def browser_stream(websocket: WebSocket, thread_id: ThreadId) -> None:
    ...
    try:
        from workguide.community.browser_automation import (
