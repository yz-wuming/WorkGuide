...
This directory contains detailed documentation for the WorkGuide backend.
...
| Document | Description |
|----------|-------------|
| [STREAMING.md](STREAMING.md) | Token-level streaming design: Gateway vs WorkGuideClient paths, `stream_mode` semantics, per-id dedup |
...
1. **New to WorkGuide?** Start with [SETUP.md](SETUP.md) for quick installation
