...
1. Start WorkGuide locally using any working development setup you already use.
   ...
   If you already have WorkGuide running locally, you can reuse that existing setup.
...
- Default local runtime target: `backend/.workguide/memory.json`
