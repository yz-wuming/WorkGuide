...
from workguide.subagents import batch_service as service_module
from workguide.subagents.batch_runtime import BatchSubmitRequest
...
async def test_execute_item_marks_real_running_then_persists_terminal_result(monkeypatch) -> None:
    ...
    monkeypatch.setattr("workguide.tools.get_available_tools", lambda **_kwargs: [])
    service = SubagentBatchService(
        repository=repository,
