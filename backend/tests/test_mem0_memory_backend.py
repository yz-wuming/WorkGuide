...
from workguide.agents.memory.backends.mem0.client import Mem0APIError, Mem0AuthError, Mem0Client
from workguide.agents.memory.backends.mem0.config import Mem0Config
...
from workguide.agents.memory.backends.mem0.message_filtering import (  # noqa: E402
...
from workguide.agents.memory.backends.mem0.mem0_manager import Mem0Manager  # noqa: E402
...
class TestMem0ManagerConstruction:
    def test_from_config_fail_fast_pings(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        fake = FakeMem0Client()
        monkeypatch.setattr(
            "workguide.agents.memory.backends.mem0.mem0_manager.Mem0Client",
            lambda **kwargs: fake,
        )
...
class TestMem0Discovery:
    def test_scan_backends_registers_mem0(self) -> None:
        import workguide.agents.memory.manager as manager_module
    ...
    def test_factory_resolves_mem0(self, monkeypatch: pytest.MonkeyPatch) -> None:
        from workguide.agents.memory.manager import get_memory_manager, reset_memory_manager
