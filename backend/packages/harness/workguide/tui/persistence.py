...
class _LoopThread:
    ...
    def __init__(self) -> None:
        ...
        self._thread = threading.Thread(target=self._run, name="workguide-tui-db", daemon=True)
        self._thread.start()
...
def build_persistence() -> tuple[_LoopThread, ThreadMetaWriter]:
    ...
    try:
        ...
        from workguide.persistence.engine import get_session_factory, init_engine_from_config
