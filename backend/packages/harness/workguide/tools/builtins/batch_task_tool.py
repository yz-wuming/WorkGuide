...
from workguide.subagents.batch_runtime import (
    BatchSubmitRequest,
    SubagentBatchSubmitter,
    get_subagent_batch_submitter,
)
from workguide.subagents.registry import get_available_subagent_names, get_subagent_config
...
async def batch_task(
    ...
    """Submit many independent items to WorkGuide's explicit durable batch mode.
