"""Tests for workguide.skills.installer — shared skill installation logic."""
...
from workguide.skills.installer import (
...
class TestEntryCountCapAppliesRegardlessOfSkillScan:
    ...
    def test_scan_archive_preflight_independently_flags_the_same_archive(self, tmp_path):
        ...
        from workguide.skills.skillscan.orchestrator import scan_archive_preflight
...
class TestInstallSkillFromArchive:
    ...
    def test_install_with_warning_findings_succeeds_and_writes_only_the_skill(self, tmp_path, monkeypatch):
        monkeypatch.setenv("WORKGUIDE_HOME", str(tmp_path / "runtime-home"))
    ...
    def test_shebang_sniff_only_reads_extensionless_files(self, tmp_path, monkeypatch):
        ...
        import workguide.skills.installer as installer_module
    ...
    def test_static_scan_failure_blocks_install_before_llm_scan(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("workguide.skills.installer.enforce_static_scan", _broken_static_scan)
        monkeypatch.setattr("workguide.skills.installer.scan_skill_content", _scan)
    ...
    def test_static_scan_runs_off_event_loop_thread(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("workguide.skills.installer.enforce_static_scan", _static_scan)
        monkeypatch.setattr("workguide.skills.installer.scan_skill_content", _scan)
    ...
    def test_copy_failure_does_not_leave_partial_install(self, tmp_path, monkeypatch):
        ...
        skills_root = tmp_path / "skills"
        skills_root.mkdir()
        monkeypatch.setattr("workguide.skills.installer.enforce_static_scan", lambda skill_dir, *, skill_name=None, app_config=None: [])
        ...
        monkeypatch.setattr("workguide.skills.installer.shutil.copytree", _copytree)
    ...
    def test_move_failure_cleans_reserved_target(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("workguide.skills.installer.shutil.move", _move)
