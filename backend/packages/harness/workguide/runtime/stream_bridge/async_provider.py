...
Usage (e.g. FastAPI lifespan)::
    ...
    from workguide.agents.stream_bridge import make_stream_bridge
...
from workguide.config.stream_bridge_config import StreamBridgeConfig, get_stream_bridge_config

from .base import StreamBridge

logger = logging.getLogger(__name__)

_ENV_REDIS_URL = "WORKGUIDE_STREAM_BRIDGE_REDIS_URL"
