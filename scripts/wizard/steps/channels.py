...
CHANNEL_CONNECTION_OPTIONS: tuple[tuple[str, str, str], ...] = (
    ("telegram", "Telegram", "direct messages through your WorkGuide bot"),
    ("slack", "Slack", "workspace messages and mentions"),
    ("discord", "Discord", "server messages through your WorkGuide bot"),
    ("feishu", "Feishu / Lark", "messages through your WorkGuide app"),
    ("dingtalk", "DingTalk", "Stream Push messages through your WorkGuide bot"),
    ("wechat", "WeChat", "iLink messages through your WorkGuide bot"),
    ("wecom", "WeCom", "messages through your WorkGuide AI bot"),
)
...
def run_channels_step(step_label: str = "Step 4/5") -> ChannelConnectionsStepResult:
    ...
    print_info("Choose which IM channels should appear in the WorkGuide sidebar and Settings.")
