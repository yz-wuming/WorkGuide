...
``workguide.extensions.ordering.core_ordering_constraints``): this is the
...
normalized ``workguide_tool_meta`` status when stamped (ToolErrorHandling runs
...
from workguide.agents.middlewares.message_utils import insert_after_leading_system_messages, is_genuine_user_message
from workguide.agents.middlewares.tool_receipt import TOOL_RECEIPT_KEY, extract_tool_receipts, make_tool_receipt, render_tool_receipts

logger = logging.getLogger(__name__)

_RECEIPT_CONTEXT_KEY = "workguide_tool_receipt_context"
