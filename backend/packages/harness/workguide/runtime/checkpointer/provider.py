...
Usage::
    ...
    from workguide.runtime.checkpointer.provider import get_checkpointer, checkpointer_context
...
from workguide.config.checkpointer_config import CheckpointerConfig, ensure_config_loaded, get_checkpointer_config
from workguide.persistence.postgres_schema import dsn_with_search_path, ensure_postgres_schema
from workguide.runtime.checkpoint_mode import frozen_checkpoint_channel_mode
from workguide.runtime.store._sqlite_utils import ensure_sqlite_parent_dir, resolve_sqlite_conn_str
...
POSTGRES_INSTALL = (
    "langgraph-checkpoint-postgres is required for the PostgreSQL checkpointer. Install the package extra with: pip install 'workguide-harness[postgres]' (or use: uv sync --all-packages --extra postgres when developing locally)"
)
...
def _resolve_checkpointer_config(app_config: AppConfig) -> CheckpointerConfig:
    ...
    :func:`~workguide.runtime.checkpointer.async_provider.make_checkpointer`
...
def _wrap_sync_if_delta(saver: Checkpointer, app_config: AppConfig) -> Checkpointer:
    ...
    from workguide.runtime.checkpoint_cache.provider import checkpoint_cache_key_prefix
    from workguide.runtime.checkpointer.cached_saver import CachedHistorySaver
