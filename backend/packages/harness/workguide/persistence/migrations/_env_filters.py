"""Object filters used by ``env.py`` to scope alembic to WorkGuide tables.
...
``./data/workguide.db``. That is the path both exclusions cover, and it is why
...
def _host_table_names() -> frozenset[str]:
    ...
    """
    import workguide.persistence.models  # noqa: F401 - registers ORM tables onto Base.metadata
