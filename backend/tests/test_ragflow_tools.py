...
import workguide.community.ragflow.tools as ragflow_tools
from workguide.community.ragflow.client import RAGFlowAPIError, RAGFlowConnectionError
from workguide.community.ragflow.formatting import format_retrieval_result
from workguide.config.tool_config import ToolConfig
...
async def test_missing_bound_dataset_returns_indexed_operator_guidance(
    ...
    with caplog.at_level(logging.WARNING, logger="workguide.community.ragflow.tools"):
        result = await ragflow_tools.knowledge_search("leave")
