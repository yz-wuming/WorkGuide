...
from workguide.mcp.tasks.runtime import is_mcp_task_runtime_available
...
from workguide.tools.builtins import (
...
def _is_host_bash_tool(tool: object) -> bool:
    ...
    if group == "bash":
        return True
    if use == "workguide.sandbox.tools:bash_tool":
        return True
    return False
...
def get_available_tools(
    ...
    *,
    ...
    `initialize_mcp_tools()` from workguide.mcp module.
    ...
    if getattr(skill_evolution_config, "enabled", False):
        from workguide.tools.skill_manage_tool import skill_manage_tool
    ...
    if include_mcp:
        try:
            ...
            from workguide.mcp.cache import get_cached_mcp_tools
    ...
    try:
        from workguide.tools.builtins.invoke_acp_agent_tool import build_invoke_acp_agent_tool
