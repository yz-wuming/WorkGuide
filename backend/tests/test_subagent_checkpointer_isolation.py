...
WorkGuideClient), the subagent's ``agent.astream()`` inherits it through
...
def _setup_executor_module():
    ...
    from workguide.subagents.executor import SubagentExecutor
...
class TestSubagentCheckpointerIsolation:
    ...
    def test_create_agent_receives_checkpointer_false(
        ...
        mw_module = ModuleType("workguide.agents.middlewares.tool_error_handling_middleware")
