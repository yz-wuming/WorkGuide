...
from workguide.config.extensions_config import ExtensionsConfig, McpOAuthConfig
...
class OAuthTokenManager:
    ...
    def __init__(self, oauth_by_server: dict[str, McpOAuthConfig]):
        ...
        # path (WorkGuideClient.stream() -> LangGraph ToolNode._func -> a
        # ThreadPoolExecutor -> workguide.tools.sync.make_sync_tool_wrapper's
