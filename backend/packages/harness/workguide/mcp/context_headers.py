...
``user_auth`` binds a credential to a *configured* WorkGuide user, which forces
...
from workguide.config.extensions_config import ExtensionsConfig, McpContextHeadersConfig
