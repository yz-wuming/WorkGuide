...
def test_core_constraints_are_declared():
    ...
    from workguide.extensions.ordering import core_ordering_constraints
...
def test_resolution_stays_deferred_until_first_use():
    ...
    probe = (
        "import sys\n"
        "from workguide.extensions import ordering\n"
        "targets = ('workguide.agents.middlewares.tool_progress_middleware', 'workguide.agents.middlewares.tool_error_handling_middleware')\n"
    ...
    assert "after_call ['workguide.agents.middlewares.tool_error_handling_middleware', 'workguide.agents.middlewares.tool_progress_middleware']" in result.stdout
