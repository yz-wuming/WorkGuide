...
def test_local_sandbox_client_bypasses_environment_proxy():
    ...
    with (
        patch("workguide.community.aio_sandbox.aio_sandbox.httpx.Client", return_value=sentinel_httpx) as client_cls,
        patch("workguide.community.aio_sandbox.aio_sandbox.AioSandboxClient") as sdk_cls,
    ):
...
def test_external_sandbox_client_keeps_environment_proxy_support(base_url: str):
    ...
    with (
        patch("workguide.community.aio_sandbox.aio_sandbox.httpx.Client") as client_cls,
        patch("workguide.community.aio_sandbox.aio_sandbox.AioSandboxClient") as sdk_cls,
    ):
