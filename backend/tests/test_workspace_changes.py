...
from workguide.workspace_changes import (
...
from workguide.workspace_changes.api import get_workspace_changes_response
from workguide.workspace_changes.scanner import SAMPLE_BYTES, is_sensitive_workspace_path
...
def test_count_diff_lines_ignores_only_real_headers():
    from workguide.workspace_changes.diff import _count_diff_lines
...
async def test_workspace_changes_route_forwards_include_files_flag():
    ...
    class FakeRequest:
        app = FakeApp()
        _workguide_test_bypass_auth = True
