...
from workguide.uploads.manager import claim_unique_filename, normalize_filename, write_upload_file_no_symlink
...
class FeishuChannel(Channel):
    ...
    async def _bind_connection_from_connect_code(self, *, message_id: str, chat_id: str, user_id: str, code: str) -> bool:
        ...
        await self._reply_card(message_id, "Feishu connected to WorkGuide.")
        return True
