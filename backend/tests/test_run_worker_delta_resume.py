...
from workguide.runtime.runs.worker import RunContext, _checkpoint_thread_lock, _linearize_delta_checkpoint_resume, run_agent
...
async def test_run_agent_serializes_resume_preparation_with_checkpoint_writes(monkeypatch):
    ...
    monkeypatch.setattr("workguide.runtime.runs.worker._capture_rollback_point", capture_rollback_point)
    monkeypatch.setattr("workguide.runtime.runs.worker._linearize_delta_checkpoint_resume", linearize_resume)
