...
Usage (e.g. FastAPI lifespan)::
    ...
    from workguide.runtime.store import make_store
...
from workguide.persistence.postgres_schema import dsn_with_search_path, ensure_postgres_schema_async
from workguide.runtime.store.provider import (
...
async def _async_store(config) -> AsyncIterator[BaseStore]:
    ...
    The ``config`` argument is a :class:`workguide.config.checkpointer_config.CheckpointerConfig`
