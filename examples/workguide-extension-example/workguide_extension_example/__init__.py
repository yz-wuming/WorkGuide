"""A compact, standalone WorkGuide extension exercising every contribution kind."""
...
from workguide_extension_api import ExtensionInstall, ExtensionRegistry, extension

from workguide_extension_example.plugin import (
