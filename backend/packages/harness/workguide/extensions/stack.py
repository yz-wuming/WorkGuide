...
This is where WorkGuide's stack shape is encoded. Two structural facts drive it:
...
from workguide_extension_api import AgentBuildContext, AgentScope, Placement

from workguide.extensions.anchors import (
    PlacementAnchor,
    inner_of_last,
    inner_of_last_after,
    innermost,
...
from workguide.extensions.injection import inject_middlewares
from workguide.extensions.ordering import assert_ordering
from workguide.extensions.registry import LoadedExtensions
...
def compose_with_extensions(
    ...
    """
    from workguide.extensions import get_agent_build_extensions, record_runtime_diagnostic
...
def _record_diagnostics(diagnostics) -> None:
    ...
    from workguide.extensions import record_runtime_diagnostics
