...
from workguide.skills.review import LocalDirectoryReader, analyze_skill_package, stable_json_dumps
from workguide.skills.review.cli import main as review_cli_main
from workguide.skills.review.models import PackageLimits, normalize_relative_path
from workguide.skills.review.readers import ArchivePackageReader, parse_skill_uri
...
def test_review_core_accepts_minimal_valid_skill(tmp_path):
    ...
    assert facts["schema_version"] == "workguide.skill-review.facts.v1"
...
def test_static_report_renders_chinese_labels(tmp_path):
    ...
    assert report["schema_version"] == "workguide.skill-review.report.v1"
