...
deliberately kept as a sibling to :mod:`workguide.guardrails` rather than folded
...
2. **Run-time execution deny** — reuses :class:`~workguide.guardrails.middleware.GuardrailMiddleware`
   via a thin adapter (see :mod:`workguide.authz.adapter`), catching dynamic
...
class AuthorizationProvider(Protocol):
    ...
    mechanism WorkGuide uses for models, tools, sandbox, and guardrails.
