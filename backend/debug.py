...
Requirements:
    ...
    resolves workguide-harness and app packages correctly:
...
async def main():
    ...
    from workguide.config.app_config import apply_logging_level

    app_config = get_app_config()
    apply_logging_level(app_config.log_level)

    # Delay the rest of the workguide imports until *after* logging is installed
    # so that any import-time side effects (e.g. workguide.agents starts a
    ...
    from workguide.mcp import initialize_mcp_tools
