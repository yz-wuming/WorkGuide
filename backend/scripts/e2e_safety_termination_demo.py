"""End-to-end demo: SafetyFinishReasonMiddleware on the real WorkGuide lead-agent.

What it proves
--------------
- The real ``make_lead_agent`` / ``WorkGuideClient`` pipeline is built (full
...
def main() -> int:
    ...
    # at import time via ``from workguide.models import create_chat_model``,
    ...
    # imported names.
    import workguide.agents.lead_agent.agent as lead_agent_module
    import workguide.client as client_module
