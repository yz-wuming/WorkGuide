...
from workguide.agents.thread_state import SandboxStateField, ThreadDataState
...
from workguide.sandbox import get_sandbox_provider
...
class SandboxMiddleware(AgentMiddleware[SandboxMiddlewareState]):
    ...
    #
    # Background:
    #   ``ensure_sandbox_initialized*`` in ``workguide.sandbox.tools`` mutates
