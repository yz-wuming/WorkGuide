...
def _default_tools() -> list[dict[str, Any]]:
    return [
        {"name": "image_search", "use": "workguide.community.image_search.tools:image_search_tool", "group": "web", "max_results": 5},
        {"name": "ls", "use": "workguide.sandbox.tools:ls_tool", "group": "file:read"},
        {"name": "read_file", "use": "workguide.sandbox.tools:read_file_tool", "group": "file:read"},
        {"name": "glob", "use": "workguide.sandbox.tools:glob_tool", "group": "file:read"},
        {"name": "grep", "use": "workguide.sandbox.tools:grep_tool", "group": "file:read"},
        {"name": "write_file", "use": "workguide.sandbox.tools:write_file_tool", "group": "file:write"},
        {"name": "str_replace", "use": "workguide.sandbox.tools:str_replace_tool", "group": "file:write"},
        {"name": "bash", "use": "workguide.sandbox.tools:bash_tool", "group": "bash"},
    ]
...
def _build_tools(
    *,
    ...
    if include_bash_tool:
        tools.append({"name": "bash", "use": "workguide.sandbox.tools:bash_tool", "group": "bash"})
...
def build_minimal_config(
    *,
    ...
    sandbox_use: str = "workguide.sandbox.local:LocalSandboxProvider",
    ...
    if sandbox_use == "workguide.sandbox.local:LocalSandboxProvider":
