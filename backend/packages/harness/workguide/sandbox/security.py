...
_LOCAL_SANDBOX_PROVIDER_MARKERS = (
    "workguide.sandbox.local:LocalSandboxProvider",
    "workguide.sandbox.local.local_sandbox_provider:LocalSandboxProvider",
)
...
def uses_local_sandbox_provider(config=None) -> bool:
    ...
    if sandbox_use in _LOCAL_SANDBOX_PROVIDER_MARKERS:
        return True
    return sandbox_use.endswith(":LocalSandboxProvider") and "workguide.sandbox.local" in sandbox_use
