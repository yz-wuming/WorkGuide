...
:mod:`workguide.config.agents_config` dispatch here without changing behaviour).
...
Path/user resolution is done through the :mod:`workguide.config.agents_config`
...
from workguide.config import agents_config as _ac
from workguide.config.agents_config import (
    SOUL_FILENAME,
    AgentConfig,
    resolve_agent_dir,
    validate_agent_name,
