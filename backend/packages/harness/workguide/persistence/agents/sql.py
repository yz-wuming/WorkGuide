...
and uses its own small engine (see :mod:`workguide.persistence.agents.base` for
...
from workguide.persistence.agents.base import (
    AgentDeleteOutcome,
    AgentExistsError,
    AgentStore,
    parse_agent_config,
        ...
        def _enable_sqlite_pragmas(dbapi_conn, _record):  # noqa: ARG001 — SQLAlchemy contract
            ...
            try:
                try:
                    ...
                    # Mirror engine.py: on filesystems that cannot create the
                    # -wal/-shm sidecar files (e.g. Docker Desktop Windows bind
                    # mounts) fall back to the default journal mode.
                    logger.warning(
